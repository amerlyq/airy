...
M.patterns = {
  ...
  NotchDid = 'GREY|DONE|FIXED|WKRND|TEMP|OLD|UNUSED|OBSOL|DEPR|DSBLD|DISABLED|TL;DR|FMT|FORMAT|RND',
  ...
  NotchMsg = 'PURP|NB|NOTE|N\\.B\\.|USE|USAGE|DEMO|DFL|DEFAULT|STD|SUM|SUMMARY|DBG|DEBUG|I\\.A|i\\.a|DEP|DEPs|DEPENDS',

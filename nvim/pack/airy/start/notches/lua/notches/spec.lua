--%GenBy: /data/aura/just/flower/notches/luagen.py
local M = {}
...
M.patterns = {
  ...
  NotchHdr = 'OFF|OFFL|OFCL|OFFICIAL|DRAW|DIY|MAKE|WF|WFs|WORKFLOW|PRIA|PRIOR_ART|FUT|FUTURE|RE|REV\\-ENG|REVL|REVEAL|XLR|EXPLORE|XP|XPMT',

...
noremap <unique> <silent> <Leader>g: :Tabularize /:\s*\zs\S/l1l0<CR>
noremap <unique> <silent> <Leader>g# :Tabularize /#\ze[^#]*$/l2l1<CR>
noremap <unique> <silent> <Leader>g<bar> :Tabularize /<bar>/l1l1<CR>

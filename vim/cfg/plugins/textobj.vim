...
\\n   call Map_nxo('[[', '<Plug>(textobj-diff-hunk-p)', 'nxo', 0)
\\n   call Map_nxo(']]', '<Plug>(textobj-diff-hunk-n)', 'nxo', 0)
\\n   call Map_nxo('[{', '<Plug>(textobj-diff-file-p)', 'nxo', 0)
\\n   call Map_nxo(']}', '<Plug>(textobj-diff-file-n)', 'nxo', 0)
\", 'hook_add': "
